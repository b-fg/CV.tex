...
\begin{p}
computational fluid dynamics; turbulence modelling; machine learning and data-driven models; numerical methods; high-performance computing.
\end{p}
...
\begin{p1}
	\begin{tabular}{p{\dimexpr 0.85\linewidth-2\tabcolsep} >{\raggedleft\arraybackslash}p{\dimexpr 0.15\linewidth-\tabcolsep}}
		\tabitem PPPL Computer Science Department's Machine Learning seminar, Princeton University & 2021 \\
		\tabitem Engineering Mind Podcast: CFD + Machine Learning, Turbulence \& PhD Life (\href{https://youtu.be/d1O3dFgvAP4}{\texttt{url}}) & 2021 \\
		\tabitem Applied Mathematics in Aerospace Engineering seminar, Universidad Politecnica Madrid & 2021 \\
		\tabitem Applied Math Colloquium, University North Carolina & 2021 \\
		\tabitem Ocean Engineering, University Rhode Island & 2021 \\
		\tabitem Fluid Dynamics Group Institute of High Performance Computing (A*STAR) & 2020 \\
		\tabitem Fluid Structure Interactions Group seminar series, University of Southampton & 2020 \\
	\end{tabular}
\end{p1}
...
\textbf{MSc projects} \\
\begin{tabular}{p{\dimexpr 0.85\linewidth-2\tabcolsep} >{\raggedleft\arraybackslash}p{\dimexpr 0.15\linewidth-\tabcolsep}}
	\tabitem Machine learning wall model for bluff bodies forces calculation & 2019 \\
	\tabitem Accurate flow interpolation using optimal transport theory & 2018 \\
\end{tabular} \\
...
\begin{itemize}
	\item \href{https://github.com/weymouth/WaterLily.jl}{\texttt{WaterLily.jl}} (co-developer): Fast CFD Julia solver based in the finite-volume and immersed boundary methods with backend-agnostic execution (CPU and GPU).
	\item \href{https://github.com/b-fg/SANSpy}{\texttt{SANSpy}}: Spanwise-averaged Navier–Stokes modelling through convolutional neural networks.
	\item \href{https://github.com/b-fg/f2py-sockets}{\texttt{f2py-sockets}}: Data transfer from Fortran to Python and viceversa using sockets.
	\item \href{https://github.com/b-fg/Flower1D}{\texttt{Flower1D}}: Flux reconstruction fluid flow solver for 1D PDEs written in Julia.
	\item \href{https://github.com/b-fg/nuatsbot}{\texttt{nuatsbot}}: Technical analysis trading bot.
\end{itemize}
\end{p}
