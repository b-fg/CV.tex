...
\input{.scholar_cache/scholar_data.tex}
...
\vspace{-13pt}
\hspace*{-18pt}{\hfill\href{https://scholar.google.com/citations?hl=en&user=FSwTh_gAAAAJ}{\texttt{Google scholar}}: Citations $=\citations{}$, h-index $=\hindex{}$, i10-index $=\iindex{}$}\\
\begin{p1}
\textbf{Peer-reviewed journal articles}
\begin{etaremune}
    \item \bibentry{Montala2026c}
    \item \bibentry{Chillon2026}
    \item \bibentry{Montala2026a}
    \item \bibentry{Rubio2025}
    \item \bibentry{Sababha2025}
    \item \bibentry{Xiao2025}
    \item \bibentry{WeymouthFont2025}
    \item \bibentry{Gao2025}
...
\begin{etaremune}
    \item \bibentry{Font2026ParCFD}
    \item \bibentry{Montala2025ETMM}
    \item \bibentry{Montala2025AIFD}
...
\begin{etaremune}
    \item \bibentry{talk20}
    \item \bibentry{talk19}
    \item \bibentry{talk18}
    \item \bibentry{talk17}
    \item \bibentry{talk16}
    \item \bibentry{talk15}
    \item \bibentry{talk14}
    \item \bibentry{talk13}
...
\begin{p1}
\begin{etaremune}
    \item \bibentry{Snellius2026}
    \item \bibentry{UniBergamo2026}
    \item \bibentry{FastFlows}
    \item \bibentry{DEAREL2}
...
\begin{etaremune}
    ...
    \item \href{https://www.nature.com/ncomms/}{Nature Communications}
    \item \href{https://link.springer.com/journal/10494}{Flow, Turbulence \& Combustion}
    \item \href{https://www.sciencedirect.com/journal/journal-of-wind-engineering-and-industrial-aerodynamics}{Journal of Wind Engineering \& Industrial Aerodynamics}
    \item \href{https://link.springer.com/journal/11071}{Nonlinear Dynamics}
    \item \href{https://www.sciencedirect.com/journal/ocean-engineering}{Ocean Engineering}
    \item \href{https://www.cambridge.org/core/journals/data-centric-engineering}{Data-Centric Engineering}
    \item \href{https://www.sciencedirect.com/journal/results-in-engineering}{Results in Engineering}
    \item \href{https://link.springer.com/journal/366}{Engineering with Computers}
\end{etaremune}
\end{p1}

\section{Committee \& Editorial Services}
\begin{p1}
\begin{etaremune}
    \item \href{https://ml4fluids2026.github.io/}{ML4Fluids 2026 Conference orginizing committee}
    \item Guest Editor for Machine Learning for Fluid Dynamics 2026 Special Issue of Flow, Turbulence and Combustion
    \item \href{https://www.ercoftac.org/about/ercoftac-da-vinci-competition/}{ERCOFTAC da Vinci PhD award 2026 selection committee}
\end{etaremune}
\end{p1}
...
\vspace{5pt}
\begin{tabular}{p{\dimexpr 0.89\linewidth-2\tabcolsep} >{\raggedleft\arraybackslash}p{\dimexpr 0.11\linewidth-\tabcolsep}}
	\tabitem E. Chillón, Machine-learning methods for accelerating scale-resolving simulations of turbulent flows, TU Delft & 2026--\\
...
\vspace{5pt}
\begin{tabular}{p{\dimexpr 0.89\linewidth-2\tabcolsep} >{\raggedleft\arraybackslash}p{\dimexpr 0.11\linewidth-\tabcolsep}}
	\tabitem Gaussian bump Bayesian optimization for turbulence transition control, TU Delft & 2026 \\
	\tabitem Matthias Claeys, Accelerating Incompressible CFD with Latent-Space Neural ODEs, TU Delft (\href{https://repository.tudelft.nl/record/uuid:39dd3adc-9c14-460d-9253-14b45d6679cb}{\texttt{url}}) & 2026 \\
	\tabitem E. van der Weide, Numerical model of Sarsia tubulosa jellyfish, TU Delft (\href{https://repository.tudelft.nl/record/uuid:341ea62d-250a-49dc-a6af-fe81bd77a627}{\texttt{url}}) & 2026 \\
	\tabitem E. Chillón, Acceleration of an AMG pressure solver using graph neural networks, TU Delft (\href{https://repository.tudelft.nl/record/uuid:48c769a9-c336-482f-ba06-61e5088725b5}{\texttt{url}}) & 2025 \\
	\tabitem B.U. Ekizoğlu, Predicting wake-induced interactions of tandem Flettner rotors, TU Delft (\href{https://repository.tudelft.nl/record/uuid:924cb7b7-483d-42a8-a977-9a6996fa3f72}{\texttt{url}}) & 2025 \\
	\tabitem K. von Streit, Flow field prediction using physics based machine learning, University of Southampton & 2020 \\
	\tabitem I. Elizalde Castells, Machine-learning wall model for bluff bodies forces calculation, University of Southampton & 2019 \\
\end{tabular}\\
...
\vspace{5pt}
\begin{tabular}{p{\dimexpr 0.89\linewidth-2\tabcolsep} >{\raggedleft\arraybackslash}p{\dimexpr 0.11\linewidth-\tabcolsep}}
	\tabitem I. Simó Muñoz, Discovering new scaling laws in turbulent boundary layers via multi-expression programming, Universitat Polit\`{e}cnica de Catalunya (\href{http://hdl.handle.net/2117/372288}{\texttt{url}}) & 2021 \\
	\tabitem M. Tosquella Riera, Discovering new expressions for the vortex trajectories and velocity profiles of synthetic jets, Universitat Polit\`{e}cnica de Catalunya (\href{http://hdl.handle.net/2117/365135}{\texttt{url}}) & 2021 \\
\end{tabular} \\
\end{p11}
...
\end{tabular}
\begin{itemize}
	\item Instructor at Computational Fluid Dynamics for Engineers (ME45155): Machine learning for CFD
...
\section{Software}
\begin{p11}
\textbf{Programming languages \& libraries}: Fortran, Julia, MPI, Python with PyTorch, Keras, and Tensorflow.
